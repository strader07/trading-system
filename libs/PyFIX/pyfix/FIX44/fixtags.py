...
def repeatingGroupIdentifiers():
    return {
        ...
        NoMDEntries : [MDEntryType, MDUpdateAction, DeleteReason, MDEntryID, MDEntryPx, MDEntrySize, MDEntryDate, MDEntryTime, TickDirection, QuoteCondition, TradeCondition, Currency, TimeInForce, ExpireDate, ExpireTime, MinQty, ExecInst, OrderID, AggressorIndicator]
    }
