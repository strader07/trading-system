...
class Tree(object):
    ...
    def create_price(self, price):
        new_list = OrderList()
        self.price_tree[price] = new_list
    ...
    def update_price_level(self, tick):
        """
        We treat level 2 book as a single order at each price level.
        """
        self.price_map[tick.price].head_order.update_qty(tick.qty, tick.timestamp)
